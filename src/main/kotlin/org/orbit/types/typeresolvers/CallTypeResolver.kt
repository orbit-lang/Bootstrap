...
class CallTypeResolver(override val node: MethodCallNode, override val binding: Binding, private val expectedType: TypeProtocol? = null) : TypeResolver<MethodCallNode, TypeProtocol>, KoinComponent {
