...
object SignatureSelfMonomorphiser : Monomorphiser<Signature, IType, Signature> {
    ...
    override fun monomorphise(ctx: Ctx, input: Signature, over: IType): MonomorphisationResult<Signature> {
