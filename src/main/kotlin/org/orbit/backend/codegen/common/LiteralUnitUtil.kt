...
object LiteralUnitUtil : KoinComponent {
    ...
    fun <T> generateLiteralUnit(node: ILiteralNode<T>, depth: Int) : AbstractLiteralUnit<T> = when (node) {
        is IntLiteralNode -> codeGenFactory.getIntLiteralUnit(node as ILiteralNode<Pair<Int, BigInteger>>, depth) as AbstractLiteralUnit<T>
