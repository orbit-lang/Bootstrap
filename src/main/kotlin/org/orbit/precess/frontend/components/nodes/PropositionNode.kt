...
data class PropositionNode(override val firstToken: Token, override val lastToken: Token, val propId: String, val body: PropositionExpressionNode) : IStatementNode {
